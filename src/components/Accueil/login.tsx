                    ...
                    <form className="rounded-5 shadow-5-strong p-5">
                        ...
                        <div className="col text-center text-white align-items-center mb-5 mt-5">
                            ...
                            <div className="form-outline mb-3">
                                <input type="email" id="form1Example1" className="form-control" placeholder="Email" /* onChange={(event) => setEmailLogInput(event.target.value)} */></input>
                            </div>

                            {/* <!-- Password input --> */}
                            <div className="form-outline mb-4 mt-4">
                                <input type="password" id="form1Example2" className="form-control" placeholder="Mot de passe" /* onChange={(event) => setPasswordLogInput(event.target.value)} */></input>
                            </div>

                            {/* <!-- Submit button Login--> */}
                            <div className="col-center text-center align-items-center mt-5">
                                <button type="submit" className="btn btn-primary btn-block col-12">Se connecter</button>
                            </div>
                            ...
                            <div className="col-center text-center align-items-center mt-4">
                                <button type="button" className="btn btn btn-dark btn-block col-8" data-bs-toggle="modal" data-bs-target="#staticBackdrop" /* onClick={fetchDataLog} */>Créez votre compte</button>
                            </div>
